...
<head>
	...
	<title>Tamu PTSP | Pengambilan Penetapan</title>
	      ...
	      <div class="row mb-2">
	        ...
	        <div class="col-sm-6">
	          <ol class="breadcrumb float-sm-right">
	            ...
	            <li class="breadcrumb-item active">Pengambilan Salinan Penetapan</li>
	          </ol>
	        </div>
	      </div>
	      <div class="row mb-2">
	        <div class="col-sm-2">
	          <a href="penetapan_tambah" class="btn btn-block bg-gradient-primary">
	      ...
	      <div class="row">
	        <div class="col-md-12">
	          <!-- <div class="card card-primary">
	            ...
	            <div class="card-body"> -->
	            <div class="card card-primary">
	              <table id="dt_penetapan" class="table table-bordered table-hover">
	                <thead>
	                  <tr>
	                    <th></th>
	                    <th>NO</th>
...
<script type="text/javascript">
	...
	function hapusData(id)
	  {
	    $.ajax({
	      url: "<?php echo base_url('produk/penetapan_hapus/') ?>"+id,
	      dataType: "text",
	...
	$(document).ready(function(){
		...
		dt_penetapan = $("#dt_penetapan").DataTable({
			"dom" : 'Bfrtip',
	        // "buttons" : [
	        //     {
	        //         extend: 'excelHtml5',
			...
			"order" : [[1, "asc"]],
			"ajax" : {
				"url" : "<?php echo base_url(); ?>produk/data_penetapan",
				"dataSrc" : "",
			},
			"columns" : [
			{"data" : "id"},
			...
			// }},
			{"data" : null, "sortable" : false, render: function(data,type,row,meta){
				return "<a href='<?php echo base_url('upload/penetapan/')?>"+row['foto']+"' data-lightbox="+row['foto']+" data-title='"+row['nama']+"'><img src='<?php echo base_url('upload/penetapan/')?>"+row['foto']+"' width='64' loading='lazy' /></a>";
			}},
			{"data" : null, "sortable" : false, render: function(data,type,row,meta){
				return "<a href='<?php echo base_url('produk/penetapan_ubah/') ?>"+row['id']+"' class='btn btn-warning'><i class='fas fa-edit'></i>Ubah</a>";
			}},
			{"data" : null, "sortable" : false, render: function(data,type,row,meta){
		...
		$("#dt_penetapan tbody").on('click', 'tr .deleteButton', function(e){
		  e.preventDefault();
		  // var currentRow = $(this).closest("tr");
		  var currentRow = $(this).closest('li').length ? $(this).closest('li') : $(this).closest('tr');
		  var data = $("#dt_penetapan").DataTable().row(currentRow).data();
