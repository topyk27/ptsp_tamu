		            ...
		            <form role="form" method="post" enctype="multipart/form-data">
		              <div class="card-body">
		                <div class="form-group">
		                	...
		                	<input type="text" name="nama" class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>" value="<?php echo $data_putusan->nama; ?>" placeholder="Nama Lengkap" required readonly>
		                ...
		                <div class="form-group">
		                	...
		                	<input type="text" name="no_perkara" class="form-control <?php echo form_error('no_perkara') ? 'is-invalid':'' ?>" value="<?php echo $data_putusan->no_perkara; ?>" placeholder="Nomor Perkara" required readonly>
		                	<div class="invalid-feedback">
		                ...
		                <div class="form-group">
		                  ...
		                  <input type="hidden" name="pihak" class="form-control <?php echo form_error('pihak') ? 'is-invalid':'' ?>" value="<?php echo $data_putusan->pihak; ?>">
		                ...
		                <div class="form-group">
		                	...
		                	<input type="text" name="no_hp" class="form-control <?php echo form_error('no_hp') ? 'is-invalid':'' ?>" value="<?php echo $data_putusan->no_hp; ?>" placeholder="Nomor HP" required>
		                	<div class="invalid-feedback">
		                ...
		                <div class="form-group">
		                  ...
		                  <input type="text" class="form-control <?php echo form_error('tanggal') ? 'is-invalid':'' ?>" name="tanggal" value="<?php echo $data_putusan->tanggal; ?>" required>
		                  <div class="invalid-feedback">
		                ...
		                <div class="form-group">
	              			...
	              			<div class="row mt-2">
		              			<div class="output col-md-6 mb-2">
		              				...
		              				<div class="row">
		              					<img id="photo" alt="Jangan ambil foto apabila tidak mengubah foto" class="img-fluid" src="<?php echo base_url('upload/putusan/'); echo $data_putusan->foto; ?>">
		              				</div>
		              			...
		              			<div class="col-md-6 mb-2">
		              				...
		              				<div class="row">
		              					<a href="<?php echo base_url('upload/putusan/default.png'); ?>" id="box_foto_pendaftaran">
  		              					<img class="img-fluid" id="foto_pendaftaran" src="<?php echo base_url('upload/putusan/default.png'); ?>">
		              					</a>
		              				</div>
		              			</div>
	              			</div>
