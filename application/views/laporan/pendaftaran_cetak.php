		...
		<div class="row">
			<div class="col-md-12 align-items-center">
				<div class="text-center">
					...
					<h3 class="text-uppercase">LAPORAN PENDAFTARAN<br>PADA PENGADILAN AGAMA <span class="text-uppercase"><?php echo $nama_pa; ?></span><br>BULAN <?php echo $bulan; ?> TAHUN <?php echo $tahun; ?></h3>
				</div>
					...
					<table class="table table-bordered">
						<thead>
							<tr class="text-center">
								...
								<th scope="col">Penggugat / Pemohon</th>
								<th scope="col">Tergugat / Termohon</th>
							</tr>
						</thead>
						<tbody>
							<?php 
							 ...
							 <tr>
							 	...
							 	<td style="white-space: nowrap; width: 1%;"><?php echo tgl_indo($val->tanggal_pendaftaran); ?></td>
							 	<td><?php echo $val->jenis_perkara; ?></td>
							 	<td><?php echo $val->penggugat; ?></td>
							 	<td><?php echo $val->tergugat; ?></td>
							 </tr>
							 <?php $no++; endforeach; ?>
						</tbody>
					</table>
