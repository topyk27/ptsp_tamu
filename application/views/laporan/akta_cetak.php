			...
			<div class="col-md-12 align-items-center">
				<div class="text-center">
					<?php 
					 ...
					 ?>
					<h3 class="text-uppercase">LAPORAN PENGAMBILAN AKTA CERAI<br>PADA PENGADILAN AGAMA <span class="text-uppercase"><?php echo $nama_pa; ?></span><br>BULAN <?php echo $bulan; ?> TAHUN <?php echo $tahun; ?></h3>
				</div>
