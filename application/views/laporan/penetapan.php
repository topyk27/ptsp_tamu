...
<head>
	...
	<title>Laporan | Salinan Penetapan</title>
	...
	<div class="content-wrapper">
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1>Salinan Penetapan</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
							<li class="breadcrumb-item">Laporan</li>
							<li class="breadcrumb-item active">Salinan Penetapan</li>
						</ol>
					</div>
				</div>
				<div class="row mb-2">
					...
					<div class="col-md-12">
						<div class="card card-primary">
							<div class="card-header">
								<h3 class="card-title">Cetak Laporan Salinan Penetapan</h3>
							</div>
							<div class="card-body">
								...
								<table id="dt_laporan_penetapan" class="table table-bordered table-hover">
									<thead>
										<tr>
											<th></th>
											<th>NO.</th>
...
<script type="text/javascript">
	var dt_laporan_penetapan;
	function filterData(data)
	{
	  $.ajax({
	    type: 'POST',
	    url: "<?php echo base_url('laporan/data_laporan_filter/penetapan'); ?>",
	    data: data,
	...
	function cetak()
	{
		...
		window.open("<?php echo base_url('laporan/cetak_laporan/penetapan/'); ?>"+bulan+'/'+tahun);
	}

	$(document).ready(function(){
		$("#sidebar_laporan").addClass("active");
		$("#sidebar_laporan_penetapan").addClass("active");
		moment.locale('id');
		$.fn.dataTable.moment('LL');
		dt_laporan_ac = $("#dt_laporan_penetapan").DataTable({
			dom : 'Bfrtip',
			order : [[1,'asc']],
			ajax : {
			  url: "<?php echo base_url('laporan/data_laporan/penetapan'); ?>",
			  dataSrc : "",
			},
			columns : [
			{data : "id"},
