	...
	<div class="content-wrapper">
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1>Salinan Putusan</h1>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
							<li class="breadcrumb-item">Laporan</li>
							<li class="breadcrumb-item active">Salinan Putusan</li>
						</ol>
					</div>
				</div>
				<div class="row mb-2">
					...
					<div class="col-md-12">
						<div class="card card-primary">
							<div class="card-header">
								<h3 class="card-title">Cetak Laporan Salinan Putusan</h3>
							</div>
							<div class="card-body">
								...
								<table id="dt_laporan_putusan" class="table table-bordered table-hover">
									<thead>
										<tr>
											<th></th>
											<th>NO.</th>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#sidebar_laporan_putusan").addClass("active");
		moment.locale('id');
		$.fn.dataTable.moment('LL');
		dt_laporan_ac = $("#dt_laporan_putusan").DataTable({
			dom : 'Bfrtip',
			order : [[1,'asc']],
			ajax : {
