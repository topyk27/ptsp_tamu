                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control <?php echo form_error('informasi') ? 'is-invalid':'' ?>" name="informasi">
                      <option value="perkara" <?php if($data_informasi->informasi == "perkara"){ echo set_select('informasi', 'perkara', TRUE); } ?>>Perkara</option>
                      <option value="non perkara" <?php if($data_informasi->informasi == "non perkara"){ echo set_select('informasi', 'non perkara', TRUE); } ?>>Non Perkara</option>
                    </select>
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    ...
                    <div class="camera">
                      ...
                      <div class="output">
                        <img id="photo" alt="Gambar kamera akan muncul di kotak ini" src="<?php echo base_url('upload/informasi/'); echo $data_informasi->foto; ?>">
